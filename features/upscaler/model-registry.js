...
export const UPSCALER_MODELS = [
  ...
  { url: 'models/RMBN_M4C8_FACES_x4.onnx', scale: 4, range: 255, label: '4x Lightweight M8C16 Faces (RMBN)' },
  { url: 'models/RMBN_M8C16_OTF_x4_FACES.onnx', scale: 4, range: 255, label: '4x Lightweight M16C32 Faces (RMBN)' },
