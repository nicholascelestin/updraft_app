...
// Canonical kinds for the `kind` field on backend-event payloads.
// `attempt`  -- engine is about to try this EP
// `success`  -- this EP loaded/ran successfully
// `fallback` -- this EP failed and the engine is dropping to the next one
// `skipped`  -- this EP was skipped without attempting (e.g. unsupported here)
export const BACKEND_EVENT_KIND = Object.freeze({
  ATTEMPT: 'attempt',
  SUCCESS: 'success',
  FALLBACK: 'fallback',
  SKIPPED: 'skipped',
